  ...
  fromJSON(object: any): Network {
    return {
      ...
      labels: isObject(object.labels)
        ...
        : {},
      defaultSecurityGroupId: isSet(object.defaultSecurityGroupId)
        ? globalThis.String(object.defaultSecurityGroupId)
        : "",
    };
  },
...
function createBaseNetwork_LabelsEntry(): Network_LabelsEntry {
  return { $type: "yandex.cloud.vpc.v1.Network.LabelsEntry", key: "", value: "" };
}
...
export const Network_LabelsEntry = {
  ...
  create<I extends Exact<DeepPartial<Network_LabelsEntry>, I>>(base?: I): Network_LabelsEntry {
    return Network_LabelsEntry.fromPartial(base ?? ({} as any));
  },

...
function createBaseApplicationAttempt(): ApplicationAttempt {
  return { $type: "yandex.cloud.dataproc.manager.v1.ApplicationAttempt", id: "", amContainerId: "" };
}
...
function createBaseApplicationInfo(): ApplicationInfo {
  return { $type: "yandex.cloud.dataproc.manager.v1.ApplicationInfo", id: "", applicationAttempts: [] };
}
...
function createBaseMapreduceJob_PropertiesEntry(): MapreduceJob_PropertiesEntry {
  return { $type: "yandex.cloud.dataproc.manager.v1.MapreduceJob.PropertiesEntry", key: "", value: "" };
}
...
function createBaseSparkJob_PropertiesEntry(): SparkJob_PropertiesEntry {
  return { $type: "yandex.cloud.dataproc.manager.v1.SparkJob.PropertiesEntry", key: "", value: "" };
}
...
function createBasePysparkJob_PropertiesEntry(): PysparkJob_PropertiesEntry {
  return { $type: "yandex.cloud.dataproc.manager.v1.PysparkJob.PropertiesEntry", key: "", value: "" };
}
...
function createBaseQueryList(): QueryList {
  return { $type: "yandex.cloud.dataproc.manager.v1.QueryList", queries: [] };
}
...
function createBaseHiveJob_PropertiesEntry(): HiveJob_PropertiesEntry {
  return { $type: "yandex.cloud.dataproc.manager.v1.HiveJob.PropertiesEntry", key: "", value: "" };
}
...
function createBaseHiveJob_ScriptVariablesEntry(): HiveJob_ScriptVariablesEntry {
  return { $type: "yandex.cloud.dataproc.manager.v1.HiveJob.ScriptVariablesEntry", key: "", value: "" };
}

...
export * as instancegroup_instance_group from './v1/instancegroup/instance_group';
export * as instancegroup_instance_group_service from './v1/instancegroup/instance_group_service';
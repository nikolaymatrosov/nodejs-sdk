...
function createBaseGetTargetGroupRequest(): GetTargetGroupRequest {
  return { $type: "yandex.cloud.apploadbalancer.v1.GetTargetGroupRequest", targetGroupId: "" };
}
...
function createBaseListTargetGroupsResponse(): ListTargetGroupsResponse {
  return { $type: "yandex.cloud.apploadbalancer.v1.ListTargetGroupsResponse", targetGroups: [], nextPageToken: "" };
}
...
function createBaseDeleteTargetGroupRequest(): DeleteTargetGroupRequest {
  return { $type: "yandex.cloud.apploadbalancer.v1.DeleteTargetGroupRequest", targetGroupId: "" };
}
...
function createBaseDeleteTargetGroupMetadata(): DeleteTargetGroupMetadata {
  return { $type: "yandex.cloud.apploadbalancer.v1.DeleteTargetGroupMetadata", targetGroupId: "" };
}
...
function createBaseUpdateTargetGroupRequest_LabelsEntry(): UpdateTargetGroupRequest_LabelsEntry {
  return { $type: "yandex.cloud.apploadbalancer.v1.UpdateTargetGroupRequest.LabelsEntry", key: "", value: "" };
}
...
function createBaseUpdateTargetGroupMetadata(): UpdateTargetGroupMetadata {
  return { $type: "yandex.cloud.apploadbalancer.v1.UpdateTargetGroupMetadata", targetGroupId: "" };
}
...
function createBaseCreateTargetGroupRequest_LabelsEntry(): CreateTargetGroupRequest_LabelsEntry {
  return { $type: "yandex.cloud.apploadbalancer.v1.CreateTargetGroupRequest.LabelsEntry", key: "", value: "" };
}
...
function createBaseCreateTargetGroupMetadata(): CreateTargetGroupMetadata {
  return { $type: "yandex.cloud.apploadbalancer.v1.CreateTargetGroupMetadata", targetGroupId: "" };
}
...
function createBaseAddTargetsRequest(): AddTargetsRequest {
  return { $type: "yandex.cloud.apploadbalancer.v1.AddTargetsRequest", targetGroupId: "", targets: [] };
}
...
function createBaseAddTargetsMetadata(): AddTargetsMetadata {
  return { $type: "yandex.cloud.apploadbalancer.v1.AddTargetsMetadata", targetGroupId: "" };
}
...
function createBaseRemoveTargetsRequest(): RemoveTargetsRequest {
  return { $type: "yandex.cloud.apploadbalancer.v1.RemoveTargetsRequest", targetGroupId: "", targets: [] };
}
...
function createBaseRemoveTargetsMetadata(): RemoveTargetsMetadata {
  return { $type: "yandex.cloud.apploadbalancer.v1.RemoveTargetsMetadata", targetGroupId: "" };
}

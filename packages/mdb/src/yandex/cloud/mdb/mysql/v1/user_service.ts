...
function createBaseGetUserRequest(): GetUserRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1.GetUserRequest", clusterId: "", userName: "" };
}
...
function createBaseListUsersRequest(): ListUsersRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1.ListUsersRequest", clusterId: "", pageSize: 0, pageToken: "" };
}
...
function createBaseListUsersResponse(): ListUsersResponse {
  return { $type: "yandex.cloud.mdb.mysql.v1.ListUsersResponse", users: [], nextPageToken: "" };
}
...
function createBaseCreateUserRequest(): CreateUserRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1.CreateUserRequest", clusterId: "", userSpec: undefined };
}
...
function createBaseCreateUserMetadata(): CreateUserMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1.CreateUserMetadata", clusterId: "", userName: "" };
}
...
function createBaseUpdateUserMetadata(): UpdateUserMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1.UpdateUserMetadata", clusterId: "", userName: "" };
}
...
function createBaseDeleteUserRequest(): DeleteUserRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1.DeleteUserRequest", clusterId: "", userName: "" };
}
...
function createBaseDeleteUserMetadata(): DeleteUserMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1.DeleteUserMetadata", clusterId: "", userName: "" };
}
...
function createBaseGrantUserPermissionMetadata(): GrantUserPermissionMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1.GrantUserPermissionMetadata", clusterId: "", userName: "" };
}
...
function createBaseRevokeUserPermissionMetadata(): RevokeUserPermissionMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1.RevokeUserPermissionMetadata", clusterId: "", userName: "" };
}

...
function createBaseGetResourcePresetRequest(): GetResourcePresetRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.GetResourcePresetRequest", resourcePresetId: "" };
}
...
function createBaseListResourcePresetsRequest(): ListResourcePresetsRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.ListResourcePresetsRequest", pageSize: 0, pageToken: "" };
}

...
import { Permission, User, UserSpec } from "./user";
...
function createBaseGetUserRequest(): GetUserRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.GetUserRequest", clusterId: "", userName: "" };
}
...
function createBaseListUsersRequest(): ListUsersRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.ListUsersRequest", clusterId: "", pageSize: 0, pageToken: "" };
}
...
function createBaseListUsersResponse(): ListUsersResponse {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.ListUsersResponse", users: [], nextPageToken: "" };
}
...
function createBaseCreateUserRequest(): CreateUserRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.CreateUserRequest", clusterId: "", userSpec: undefined };
}
...
function createBaseCreateUserMetadata(): CreateUserMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.CreateUserMetadata", clusterId: "", userName: "" };
}
...
function createBaseUpdateUserMetadata(): UpdateUserMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.UpdateUserMetadata", clusterId: "", userName: "" };
}
...
function createBaseDeleteUserRequest(): DeleteUserRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.DeleteUserRequest", clusterId: "", userName: "" };
}
...
function createBaseDeleteUserMetadata(): DeleteUserMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.DeleteUserMetadata", clusterId: "", userName: "" };
}
...
function createBaseGrantUserPermissionMetadata(): GrantUserPermissionMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.GrantUserPermissionMetadata", clusterId: "", userName: "" };
}
...
function createBaseRevokeUserPermissionMetadata(): RevokeUserPermissionMetadata {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.RevokeUserPermissionMetadata", clusterId: "", userName: "" };
}

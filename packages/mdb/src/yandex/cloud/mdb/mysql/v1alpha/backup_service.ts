...
function createBaseGetBackupRequest(): GetBackupRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.GetBackupRequest", backupId: "" };
}
...
function createBaseListBackupsRequest(): ListBackupsRequest {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.ListBackupsRequest", folderId: "", pageSize: 0, pageToken: "" };
}
...
function createBaseListBackupsResponse(): ListBackupsResponse {
  return { $type: "yandex.cloud.mdb.mysql.v1alpha.ListBackupsResponse", backups: [], nextPageToken: "" };
}

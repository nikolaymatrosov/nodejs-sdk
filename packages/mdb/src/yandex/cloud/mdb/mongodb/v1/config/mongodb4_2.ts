...
function createBaseMongodConfig42_Network(): MongodConfig42_Network {
  return { $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig4_2.Network", maxIncomingConnections: undefined };
}
...
function createBaseMongosConfig42_Network(): MongosConfig42_Network {
  return { $type: "yandex.cloud.mdb.mongodb.v1.config.MongosConfig4_2.Network", maxIncomingConnections: undefined };
}

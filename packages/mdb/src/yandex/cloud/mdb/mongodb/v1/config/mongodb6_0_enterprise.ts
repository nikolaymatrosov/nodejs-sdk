...
export interface MongodConfig60Enterprise_Storage_WiredTiger {
  ...
  indexConfig?: MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig | undefined;
}
...
export interface MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig {
  $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0_enterprise.Storage.WiredTiger.IndexConfig";
...
export interface MongodConfig60Enterprise_Network {
  ...
  compression?: MongodConfig60Enterprise_Network_Compression | undefined;
}

export interface MongodConfig60Enterprise_Network_Compression {
  $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0_enterprise.Network.Compression";
  /**
   ...
   */
  compressors: MongodConfig60Enterprise_Network_Compression_Compressor[];
}

export enum MongodConfig60Enterprise_Network_Compression_Compressor {
  COMPRESSOR_UNSPECIFIED = 0,
...
export function mongodConfig60Enterprise_Network_Compression_CompressorFromJSON(
  object: any,
): MongodConfig60Enterprise_Network_Compression_Compressor {
  switch (object) {
    case 0:
    case "COMPRESSOR_UNSPECIFIED":
      return MongodConfig60Enterprise_Network_Compression_Compressor.COMPRESSOR_UNSPECIFIED;
    case 1:
    case "SNAPPY":
      return MongodConfig60Enterprise_Network_Compression_Compressor.SNAPPY;
    case 2:
    case "ZLIB":
      return MongodConfig60Enterprise_Network_Compression_Compressor.ZLIB;
    case 3:
    case "ZSTD":
      return MongodConfig60Enterprise_Network_Compression_Compressor.ZSTD;
    case -1:
    case "UNRECOGNIZED":
    default:
      return MongodConfig60Enterprise_Network_Compression_Compressor.UNRECOGNIZED;
  }
}

export function mongodConfig60Enterprise_Network_Compression_CompressorToJSON(
  object: MongodConfig60Enterprise_Network_Compression_Compressor,
): string {
  switch (object) {
    case MongodConfig60Enterprise_Network_Compression_Compressor.COMPRESSOR_UNSPECIFIED:
      return "COMPRESSOR_UNSPECIFIED";
    case MongodConfig60Enterprise_Network_Compression_Compressor.SNAPPY:
      return "SNAPPY";
    case MongodConfig60Enterprise_Network_Compression_Compressor.ZLIB:
      return "ZLIB";
    case MongodConfig60Enterprise_Network_Compression_Compressor.ZSTD:
      return "ZSTD";
    case MongodConfig60Enterprise_Network_Compression_Compressor.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface MongosConfig60Enterprise_Network {
  ...
  maxIncomingConnections?:
    ...
    | undefined;
  /** Compression settings */
  compression?: MongosConfig60Enterprise_Network_Compression | undefined;
}

export interface MongosConfig60Enterprise_Network_Compression {
  $type: "yandex.cloud.mdb.mongodb.v1.config.MongosConfig6_0_enterprise.Network.Compression";
  /**
   * Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:
   * - other members of the deployment if the instance is part of a replica set or a sharded cluster
   * - mongosh
   ...
   * MongoDB supports the following compressors:
   */
  compressors: MongosConfig60Enterprise_Network_Compression_Compressor[];
}

export enum MongosConfig60Enterprise_Network_Compression_Compressor {
  COMPRESSOR_UNSPECIFIED = 0,
  /** SNAPPY - The [Snappy](https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy) compression. */
  SNAPPY = 1,
  /** ZLIB - The [zlib](https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib) compression. */
...
export function mongosConfig60Enterprise_Network_Compression_CompressorFromJSON(
  object: any,
): MongosConfig60Enterprise_Network_Compression_Compressor {
  switch (object) {
    case 0:
    case "COMPRESSOR_UNSPECIFIED":
      return MongosConfig60Enterprise_Network_Compression_Compressor.COMPRESSOR_UNSPECIFIED;
    case 1:
    case "SNAPPY":
      return MongosConfig60Enterprise_Network_Compression_Compressor.SNAPPY;
    case 2:
    case "ZLIB":
      return MongosConfig60Enterprise_Network_Compression_Compressor.ZLIB;
    case 3:
    case "ZSTD":
      return MongosConfig60Enterprise_Network_Compression_Compressor.ZSTD;
    case -1:
    case "UNRECOGNIZED":
    default:
      return MongosConfig60Enterprise_Network_Compression_Compressor.UNRECOGNIZED;
  }
}

export function mongosConfig60Enterprise_Network_Compression_CompressorToJSON(
  object: MongosConfig60Enterprise_Network_Compression_Compressor,
): string {
  switch (object) {
    case MongosConfig60Enterprise_Network_Compression_Compressor.COMPRESSOR_UNSPECIFIED:
      return "COMPRESSOR_UNSPECIFIED";
    case MongosConfig60Enterprise_Network_Compression_Compressor.SNAPPY:
      return "SNAPPY";
    case MongosConfig60Enterprise_Network_Compression_Compressor.ZLIB:
      return "ZLIB";
    case MongosConfig60Enterprise_Network_Compression_Compressor.ZSTD:
      return "ZSTD";
    case MongosConfig60Enterprise_Network_Compression_Compressor.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const MongodConfig60Enterprise_Storage_WiredTiger = {
  ...
  encode(message: MongodConfig60Enterprise_Storage_WiredTiger, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.indexConfig !== undefined) {
      MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.encode(message.indexConfig, writer.uint32(26).fork())
        .ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.indexConfig = MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): MongodConfig60Enterprise_Storage_WiredTiger {
    return {
      ...
      indexConfig: isSet(object.indexConfig)
        ? MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.fromJSON(object.indexConfig)
        : undefined,
    };
  },
  ...
  toJSON(message: MongodConfig60Enterprise_Storage_WiredTiger): unknown {
    ...
    if (message.indexConfig !== undefined) {
      obj.indexConfig = MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.toJSON(message.indexConfig);
    }
    return obj;
  },
  ...
  fromPartial(
    ...
    message.indexConfig = (object.indexConfig !== undefined && object.indexConfig !== null)
      ? MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.fromPartial(object.indexConfig)
      : undefined;
    return message;
  },
};
...
function createBaseMongodConfig60Enterprise_Storage_WiredTiger_IndexConfig(): MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig {
  return {
    $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0_enterprise.Storage.WiredTiger.IndexConfig",
...
export const MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig = {
  $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0_enterprise.Storage.WiredTiger.IndexConfig" as const,
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMongodConfig60Enterprise_Storage_WiredTiger_IndexConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig {
    return {
      $type: MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.$type,
  ...
  create(
    base?: DeepPartial<MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig>,
  ): MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig {
    return MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig>,
  ): MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig {
    const message = createBaseMongodConfig60Enterprise_Storage_WiredTiger_IndexConfig();
...
messageTypeRegistry.set(
  MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig.$type,
  MongodConfig60Enterprise_Storage_WiredTiger_IndexConfig,
);
...
export const MongodConfig60Enterprise_Network = {
  ...
  encode(message: MongodConfig60Enterprise_Network, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.compression !== undefined) {
      MongodConfig60Enterprise_Network_Compression.encode(message.compression, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.compression = MongodConfig60Enterprise_Network_Compression.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): MongodConfig60Enterprise_Network {
    return {
      ...
      compression: isSet(object.compression)
        ? MongodConfig60Enterprise_Network_Compression.fromJSON(object.compression)
        : undefined,
    };
  },
  ...
  toJSON(message: MongodConfig60Enterprise_Network): unknown {
    ...
    if (message.compression !== undefined) {
      obj.compression = MongodConfig60Enterprise_Network_Compression.toJSON(message.compression);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<MongodConfig60Enterprise_Network>): MongodConfig60Enterprise_Network {
    ...
    message.compression = (object.compression !== undefined && object.compression !== null)
      ? MongodConfig60Enterprise_Network_Compression.fromPartial(object.compression)
      : undefined;
    return message;
  },
};
...
function createBaseMongodConfig60Enterprise_Network_Compression(): MongodConfig60Enterprise_Network_Compression {
  return {
    $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0_enterprise.Network.Compression",
    compressors: [],
  };
...
export const MongodConfig60Enterprise_Network_Compression = {
  $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0_enterprise.Network.Compression" as const,

  encode(message: MongodConfig60Enterprise_Network_Compression, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    writer.uint32(10).fork();
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MongodConfig60Enterprise_Network_Compression {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMongodConfig60Enterprise_Network_Compression();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MongodConfig60Enterprise_Network_Compression {
    return {
      $type: MongodConfig60Enterprise_Network_Compression.$type,
      compressors: globalThis.Array.isArray(object?.compressors)
        ? object.compressors.map((e: any) => mongodConfig60Enterprise_Network_Compression_CompressorFromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: MongodConfig60Enterprise_Network_Compression): unknown {
    ...
    if (message.compressors?.length) {
      obj.compressors = message.compressors.map((e) =>
        mongodConfig60Enterprise_Network_Compression_CompressorToJSON(e)
      );
    }
    return obj;
  },
  ...
  create(
    base?: DeepPartial<MongodConfig60Enterprise_Network_Compression>,
  ): MongodConfig60Enterprise_Network_Compression {
    return MongodConfig60Enterprise_Network_Compression.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<MongodConfig60Enterprise_Network_Compression>,
  ): MongodConfig60Enterprise_Network_Compression {
    const message = createBaseMongodConfig60Enterprise_Network_Compression();
...
messageTypeRegistry.set(
  MongodConfig60Enterprise_Network_Compression.$type,
  MongodConfig60Enterprise_Network_Compression,
);
...
export const MongosConfig60Enterprise_Network = {
  ...
  encode(message: MongosConfig60Enterprise_Network, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.compression !== undefined) {
      MongosConfig60Enterprise_Network_Compression.encode(message.compression, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.compression = MongosConfig60Enterprise_Network_Compression.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): MongosConfig60Enterprise_Network {
    return {
      ...
      maxIncomingConnections: isSet(object.maxIncomingConnections) ? Number(object.maxIncomingConnections) : undefined,
      compression: isSet(object.compression)
        ? MongosConfig60Enterprise_Network_Compression.fromJSON(object.compression)
        : undefined,
    };
  },
  ...
  toJSON(message: MongosConfig60Enterprise_Network): unknown {
    ...
    if (message.compression !== undefined) {
      obj.compression = MongosConfig60Enterprise_Network_Compression.toJSON(message.compression);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<MongosConfig60Enterprise_Network>): MongosConfig60Enterprise_Network {
    ...
    message.maxIncomingConnections = object.maxIncomingConnections ?? undefined;
    message.compression = (object.compression !== undefined && object.compression !== null)
      ? MongosConfig60Enterprise_Network_Compression.fromPartial(object.compression)
      : undefined;
    return message;
  },
};
...
function createBaseMongosConfig60Enterprise_Network_Compression(): MongosConfig60Enterprise_Network_Compression {
  return {
    $type: "yandex.cloud.mdb.mongodb.v1.config.MongosConfig6_0_enterprise.Network.Compression",
    compressors: [],
  };
...
export const MongosConfig60Enterprise_Network_Compression = {
  $type: "yandex.cloud.mdb.mongodb.v1.config.MongosConfig6_0_enterprise.Network.Compression" as const,

  encode(message: MongosConfig60Enterprise_Network_Compression, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    writer.uint32(10).fork();
    for (const v of message.compressors) {
      writer.int32(v);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MongosConfig60Enterprise_Network_Compression {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMongosConfig60Enterprise_Network_Compression();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MongosConfig60Enterprise_Network_Compression {
    return {
      $type: MongosConfig60Enterprise_Network_Compression.$type,
      compressors: globalThis.Array.isArray(object?.compressors)
        ? object.compressors.map((e: any) => mongosConfig60Enterprise_Network_Compression_CompressorFromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: MongosConfig60Enterprise_Network_Compression): unknown {
    ...
    if (message.compressors?.length) {
      obj.compressors = message.compressors.map((e) =>
        mongosConfig60Enterprise_Network_Compression_CompressorToJSON(e)
      );
    }
    return obj;
  },
  ...
  create(
    base?: DeepPartial<MongosConfig60Enterprise_Network_Compression>,
  ): MongosConfig60Enterprise_Network_Compression {
    return MongosConfig60Enterprise_Network_Compression.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<MongosConfig60Enterprise_Network_Compression>,
  ): MongosConfig60Enterprise_Network_Compression {
    const message = createBaseMongosConfig60Enterprise_Network_Compression();
    message.compressors = object.compressors?.map((e) => e) || [];
    return message;
...
messageTypeRegistry.set(
  MongosConfig60Enterprise_Network_Compression.$type,
  MongosConfig60Enterprise_Network_Compression,
);

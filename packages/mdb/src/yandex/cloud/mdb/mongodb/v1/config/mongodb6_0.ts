...
export interface MongodConfig60 {
  ...
  net?: MongodConfig60_Network | undefined;
}
...
export interface MongodConfig60_Storage_WiredTiger {
  ...
  collectionConfig?: MongodConfig60_Storage_WiredTiger_CollectionConfig | undefined;
}
...
function createBaseMongodConfig60_Network(): MongodConfig60_Network {
  return { $type: "yandex.cloud.mdb.mongodb.v1.config.MongodConfig6_0.Network", maxIncomingConnections: undefined };
}
...
function createBaseMongosConfig60_Network(): MongosConfig60_Network {
  return { $type: "yandex.cloud.mdb.mongodb.v1.config.MongosConfig6_0.Network", maxIncomingConnections: undefined };
}

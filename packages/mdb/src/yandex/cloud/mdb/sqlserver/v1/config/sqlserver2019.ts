...
export interface SQLServerConfigSet2019std {
  ...
  defaultConfig?: SQLServerConfig2019std | undefined;
}
...
export interface SQLServerConfigSet2019ent {
  ...
  userConfig?:
    ...
    | undefined;
  /** Default configuration for an SQL Server 2019 cluster. */
  defaultConfig?: SQLServerConfig2019ent | undefined;
}

function createBaseSQLServerConfig2019std(): SQLServerConfig2019std {
  return {
    $type: "yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2019std",
...
export const SQLServerConfig2019std = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SQLServerConfig2019std {
    ...
    const message = createBaseSQLServerConfig2019std();
  ...
  fromJSON(object: any): SQLServerConfig2019std {
    return {
      $type: SQLServerConfig2019std.$type,
  ...
  create(base?: DeepPartial<SQLServerConfig2019std>): SQLServerConfig2019std {
    return SQLServerConfig2019std.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SQLServerConfig2019std>): SQLServerConfig2019std {
    const message = createBaseSQLServerConfig2019std();
...
function createBaseSQLServerConfigSet2019std(): SQLServerConfigSet2019std {
  return {
    $type: "yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfigSet2019std",
...
export const SQLServerConfigSet2019std = {
  $type: "yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfigSet2019std" as const,

  encode(message: SQLServerConfigSet2019std, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.effectiveConfig !== undefined) {
      SQLServerConfig2019std.encode(message.effectiveConfig, writer.uint32(10).fork()).ldelim();
    }
    if (message.userConfig !== undefined) {
      SQLServerConfig2019std.encode(message.userConfig, writer.uint32(18).fork()).ldelim();
    }
    if (message.defaultConfig !== undefined) {
      SQLServerConfig2019std.encode(message.defaultConfig, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SQLServerConfigSet2019std {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSQLServerConfigSet2019std();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.effectiveConfig = SQLServerConfig2019std.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.userConfig = SQLServerConfig2019std.decode(reader, reader.uint32());
          continue;
        case 3:
          if (tag !== 26) {
            break;
          ...
          message.defaultConfig = SQLServerConfig2019std.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): SQLServerConfigSet2019std {
    return {
      $type: SQLServerConfigSet2019std.$type,
      effectiveConfig: isSet(object.effectiveConfig)
        ? SQLServerConfig2019std.fromJSON(object.effectiveConfig)
        : undefined,
      userConfig: isSet(object.userConfig) ? SQLServerConfig2019std.fromJSON(object.userConfig) : undefined,
      defaultConfig: isSet(object.defaultConfig) ? SQLServerConfig2019std.fromJSON(object.defaultConfig) : undefined,
    };
  },
  ...
  toJSON(message: SQLServerConfigSet2019std): unknown {
    const obj: any = {};
    if (message.effectiveConfig !== undefined) {
      obj.effectiveConfig = SQLServerConfig2019std.toJSON(message.effectiveConfig);
    }
    if (message.userConfig !== undefined) {
      obj.userConfig = SQLServerConfig2019std.toJSON(message.userConfig);
    }
    if (message.defaultConfig !== undefined) {
      obj.defaultConfig = SQLServerConfig2019std.toJSON(message.defaultConfig);
    }
    return obj;
  },

  create(base?: DeepPartial<SQLServerConfigSet2019std>): SQLServerConfigSet2019std {
    return SQLServerConfigSet2019std.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SQLServerConfigSet2019std>): SQLServerConfigSet2019std {
    const message = createBaseSQLServerConfigSet2019std();
...
messageTypeRegistry.set(SQLServerConfigSet2019std.$type, SQLServerConfigSet2019std);

function createBaseSQLServerConfig2019ent(): SQLServerConfig2019ent {
  return {
    $type: "yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfig2019ent",
    maxDegreeOfParallelism: undefined,
    costThresholdForParallelism: undefined,
...
export const SQLServerConfig2019ent = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SQLServerConfig2019ent {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSQLServerConfig2019ent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): SQLServerConfig2019ent {
    return {
      $type: SQLServerConfig2019ent.$type,
      maxDegreeOfParallelism: isSet(object.maxDegreeOfParallelism) ? Number(object.maxDegreeOfParallelism) : undefined,
      costThresholdForParallelism: isSet(object.costThresholdForParallelism)
        ? Number(object.costThresholdForParallelism)
        : undefined,
  ...
  create(base?: DeepPartial<SQLServerConfig2019ent>): SQLServerConfig2019ent {
    return SQLServerConfig2019ent.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SQLServerConfig2019ent>): SQLServerConfig2019ent {
    const message = createBaseSQLServerConfig2019ent();
    message.maxDegreeOfParallelism = object.maxDegreeOfParallelism ?? undefined;
    message.costThresholdForParallelism = object.costThresholdForParallelism ?? undefined;
    message.auditLevel = object.auditLevel ?? undefined;
...
function createBaseSQLServerConfigSet2019ent(): SQLServerConfigSet2019ent {
  return {
    $type: "yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfigSet2019ent",
    effectiveConfig: undefined,
    userConfig: undefined,
...
export const SQLServerConfigSet2019ent = {
  $type: "yandex.cloud.mdb.sqlserver.v1.config.SQLServerConfigSet2019ent" as const,

  encode(message: SQLServerConfigSet2019ent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.effectiveConfig !== undefined) {
      SQLServerConfig2019ent.encode(message.effectiveConfig, writer.uint32(10).fork()).ldelim();
    }
    if (message.userConfig !== undefined) {
      SQLServerConfig2019ent.encode(message.userConfig, writer.uint32(18).fork()).ldelim();
    }
    if (message.defaultConfig !== undefined) {
      SQLServerConfig2019ent.encode(message.defaultConfig, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SQLServerConfigSet2019ent {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSQLServerConfigSet2019ent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.effectiveConfig = SQLServerConfig2019ent.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.userConfig = SQLServerConfig2019ent.decode(reader, reader.uint32());
          continue;
        case 3:
          if (tag !== 26) {
            break;
          ...
          message.defaultConfig = SQLServerConfig2019ent.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): SQLServerConfigSet2019ent {
    return {
      $type: SQLServerConfigSet2019ent.$type,
      effectiveConfig: isSet(object.effectiveConfig)
        ? SQLServerConfig2019ent.fromJSON(object.effectiveConfig)
        : undefined,
      userConfig: isSet(object.userConfig) ? SQLServerConfig2019ent.fromJSON(object.userConfig) : undefined,
      defaultConfig: isSet(object.defaultConfig) ? SQLServerConfig2019ent.fromJSON(object.defaultConfig) : undefined,
    };
  },
  ...
  toJSON(message: SQLServerConfigSet2019ent): unknown {
    const obj: any = {};
    if (message.effectiveConfig !== undefined) {
      obj.effectiveConfig = SQLServerConfig2019ent.toJSON(message.effectiveConfig);
    }
    if (message.userConfig !== undefined) {
      obj.userConfig = SQLServerConfig2019ent.toJSON(message.userConfig);
    }
    if (message.defaultConfig !== undefined) {
      obj.defaultConfig = SQLServerConfig2019ent.toJSON(message.defaultConfig);
    }
    return obj;
  },

  create(base?: DeepPartial<SQLServerConfigSet2019ent>): SQLServerConfigSet2019ent {
    return SQLServerConfigSet2019ent.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SQLServerConfigSet2019ent>): SQLServerConfigSet2019ent {
    const message = createBaseSQLServerConfigSet2019ent();
    message.effectiveConfig = (object.effectiveConfig !== undefined && object.effectiveConfig !== null)

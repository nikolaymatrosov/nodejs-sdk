...
export function postgresqlHostConfig151C_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig151C_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig151C_BackslashQuoteToJSON(object: PostgresqlHostConfig151C_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig151C_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_ByteaOutputFromJSON(object: any): PostgresqlHostConfig151C_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig151C_ByteaOutputToJSON(object: PostgresqlHostConfig151C_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig151C_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_ConstraintExclusionToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig151C_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_ForceParallelModeToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig151C_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_LogErrorVerbosityToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig151C_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_LogLevelFromJSON(object: any): PostgresqlHostConfig151C_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig151C_LogLevelToJSON(object: PostgresqlHostConfig151C_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig151C_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_LogStatementFromJSON(object: any): PostgresqlHostConfig151C_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig151C_LogStatementToJSON(object: PostgresqlHostConfig151C_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig151C_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_TransactionIsolationToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig151C_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_XmlBinaryFromJSON(object: any): PostgresqlHostConfig151C_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig151C_XmlBinaryToJSON(object: PostgresqlHostConfig151C_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig151C_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig151C_XmlOptionFromJSON(object: any): PostgresqlHostConfig151C_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig151C_XmlOptionToJSON(object: PostgresqlHostConfig151C_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig151C_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig151C(): PostgresqlHostConfig151C {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig15_1C",
...
export const PostgresqlHostConfig151C = {
  $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig15_1C" as const,

  encode(message: PostgresqlHostConfig151C, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig151C {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig151C();
  ...
  fromJSON(object: any): PostgresqlHostConfig151C {
    return {
      $type: PostgresqlHostConfig151C.$type,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig151C_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig151C_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig151C_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig151C_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig151C): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig151C_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig151C_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig151C>): PostgresqlHostConfig151C {
    return PostgresqlHostConfig151C.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PostgresqlHostConfig151C>): PostgresqlHostConfig151C {
    const message = createBasePostgresqlHostConfig151C();
...
messageTypeRegistry.set(PostgresqlHostConfig151C.$type, PostgresqlHostConfig151C);

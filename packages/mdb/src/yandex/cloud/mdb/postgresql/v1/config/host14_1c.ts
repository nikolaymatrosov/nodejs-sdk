...
export enum PostgresqlHostConfig141C_BackslashQuote {
...
export function postgresqlHostConfig141C_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig141C_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_BackslashQuoteToJSON(object: PostgresqlHostConfig141C_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_ByteaOutput {
...
export function postgresqlHostConfig141C_ByteaOutputFromJSON(object: any): PostgresqlHostConfig141C_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_ByteaOutputToJSON(object: PostgresqlHostConfig141C_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_ConstraintExclusion {
...
export function postgresqlHostConfig141C_ConstraintExclusionFromJSON(
  object: any,
): PostgresqlHostConfig141C_ConstraintExclusion {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_ConstraintExclusionToJSON(
  object: PostgresqlHostConfig141C_ConstraintExclusion,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_ForceParallelMode {
...
export function postgresqlHostConfig141C_ForceParallelModeFromJSON(
  object: any,
): PostgresqlHostConfig141C_ForceParallelMode {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_ForceParallelModeToJSON(
  object: PostgresqlHostConfig141C_ForceParallelMode,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_LogErrorVerbosity {
...
export function postgresqlHostConfig141C_LogErrorVerbosityFromJSON(
  object: any,
...
export function postgresqlHostConfig141C_LogErrorVerbosityToJSON(
  object: PostgresqlHostConfig141C_LogErrorVerbosity,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_LogLevel {
...
export function postgresqlHostConfig141C_LogLevelFromJSON(object: any): PostgresqlHostConfig141C_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_LogLevelToJSON(object: PostgresqlHostConfig141C_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_LogStatement {
...
export function postgresqlHostConfig141C_LogStatementFromJSON(object: any): PostgresqlHostConfig141C_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_LogStatementToJSON(object: PostgresqlHostConfig141C_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_TransactionIsolation {
...
export function postgresqlHostConfig141C_TransactionIsolationFromJSON(
  object: any,
): PostgresqlHostConfig141C_TransactionIsolation {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_TransactionIsolationToJSON(
  object: PostgresqlHostConfig141C_TransactionIsolation,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_XmlBinary {
...
export function postgresqlHostConfig141C_XmlBinaryFromJSON(object: any): PostgresqlHostConfig141C_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_XmlBinaryToJSON(object: PostgresqlHostConfig141C_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig141C_XmlOption {
...
export function postgresqlHostConfig141C_XmlOptionFromJSON(object: any): PostgresqlHostConfig141C_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig141C_XmlOptionToJSON(object: PostgresqlHostConfig141C_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig141C_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig141C(): PostgresqlHostConfig141C {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig14_1C",
...
export const PostgresqlHostConfig141C = {
  $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig14_1C" as const,

  encode(message: PostgresqlHostConfig141C, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig141C {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig141C();
  ...
  fromJSON(object: any): PostgresqlHostConfig141C {
    return {
      $type: PostgresqlHostConfig141C.$type,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig141C_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig141C_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig141C_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig141C_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig141C): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig141C_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig141C_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig141C>): PostgresqlHostConfig141C {
    return PostgresqlHostConfig141C.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PostgresqlHostConfig141C>): PostgresqlHostConfig141C {
    const message = createBasePostgresqlHostConfig141C();
...
messageTypeRegistry.set(PostgresqlHostConfig141C.$type, PostgresqlHostConfig141C);

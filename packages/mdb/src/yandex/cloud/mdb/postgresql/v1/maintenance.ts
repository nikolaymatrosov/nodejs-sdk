...
function createBaseAnytimeMaintenanceWindow(): AnytimeMaintenanceWindow {
  return { $type: "yandex.cloud.mdb.postgresql.v1.AnytimeMaintenanceWindow" };
}
...
function createBaseWeeklyMaintenanceWindow(): WeeklyMaintenanceWindow {
  return { $type: "yandex.cloud.mdb.postgresql.v1.WeeklyMaintenanceWindow", day: 0, hour: 0 };
}
...
function createBaseMaintenanceOperation(): MaintenanceOperation {
  return { $type: "yandex.cloud.mdb.postgresql.v1.MaintenanceOperation", info: "", delayedUntil: undefined };
}

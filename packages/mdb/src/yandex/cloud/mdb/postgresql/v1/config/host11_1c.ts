...
export function postgresqlHostConfig111C_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig111C_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig111C_BackslashQuoteToJSON(object: PostgresqlHostConfig111C_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig111C_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_ByteaOutputFromJSON(object: any): PostgresqlHostConfig111C_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig111C_ByteaOutputToJSON(object: PostgresqlHostConfig111C_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig111C_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_ConstraintExclusionToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig111C_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_ForceParallelModeToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig111C_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_LogErrorVerbosityToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig111C_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_LogLevelFromJSON(object: any): PostgresqlHostConfig111C_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig111C_LogLevelToJSON(object: PostgresqlHostConfig111C_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig111C_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_LogStatementFromJSON(object: any): PostgresqlHostConfig111C_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig111C_LogStatementToJSON(object: PostgresqlHostConfig111C_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig111C_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_TransactionIsolationToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig111C_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_XmlBinaryFromJSON(object: any): PostgresqlHostConfig111C_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig111C_XmlBinaryToJSON(object: PostgresqlHostConfig111C_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig111C_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig111C_XmlOptionFromJSON(object: any): PostgresqlHostConfig111C_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig111C_XmlOptionToJSON(object: PostgresqlHostConfig111C_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig111C_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig111C(): PostgresqlHostConfig111C {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig11_1C",
...
export const PostgresqlHostConfig111C = {
  ...
  encode(message: PostgresqlHostConfig111C, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig111C {
    ...
    const message = createBasePostgresqlHostConfig111C();
  ...
  fromJSON(object: any): PostgresqlHostConfig111C {
    return {
      $type: PostgresqlHostConfig111C.$type,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig111C_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig111C_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig111C_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig111C_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig111C): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig111C_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig111C_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig111C>): PostgresqlHostConfig111C {
    return PostgresqlHostConfig111C.fromPartial(base ?? {});
  },
...
messageTypeRegistry.set(PostgresqlHostConfig111C.$type, PostgresqlHostConfig111C);

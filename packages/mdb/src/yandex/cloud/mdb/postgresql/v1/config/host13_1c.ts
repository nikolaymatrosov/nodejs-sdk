...
export enum PostgresqlHostConfig131C_BackslashQuote {
...
export function postgresqlHostConfig131C_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig131C_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_BackslashQuoteToJSON(object: PostgresqlHostConfig131C_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_ByteaOutput {
...
export function postgresqlHostConfig131C_ByteaOutputFromJSON(object: any): PostgresqlHostConfig131C_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_ByteaOutputToJSON(object: PostgresqlHostConfig131C_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_ConstraintExclusion {
...
export function postgresqlHostConfig131C_ConstraintExclusionFromJSON(
  object: any,
): PostgresqlHostConfig131C_ConstraintExclusion {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_ConstraintExclusionToJSON(
  object: PostgresqlHostConfig131C_ConstraintExclusion,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_ForceParallelMode {
...
export function postgresqlHostConfig131C_ForceParallelModeFromJSON(
  object: any,
...
export function postgresqlHostConfig131C_ForceParallelModeToJSON(
  object: PostgresqlHostConfig131C_ForceParallelMode,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_LogErrorVerbosity {
...
export function postgresqlHostConfig131C_LogErrorVerbosityFromJSON(
  object: any,
): PostgresqlHostConfig131C_LogErrorVerbosity {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_LogErrorVerbosityToJSON(
  object: PostgresqlHostConfig131C_LogErrorVerbosity,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_LogLevel {
...
export function postgresqlHostConfig131C_LogLevelFromJSON(object: any): PostgresqlHostConfig131C_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_LogLevelToJSON(object: PostgresqlHostConfig131C_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_LogStatement {
...
export function postgresqlHostConfig131C_LogStatementFromJSON(object: any): PostgresqlHostConfig131C_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_LogStatementToJSON(object: PostgresqlHostConfig131C_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_TransactionIsolation {
...
export function postgresqlHostConfig131C_TransactionIsolationFromJSON(
  object: any,
): PostgresqlHostConfig131C_TransactionIsolation {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_TransactionIsolationToJSON(
  object: PostgresqlHostConfig131C_TransactionIsolation,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_XmlBinary {
...
export function postgresqlHostConfig131C_XmlBinaryFromJSON(object: any): PostgresqlHostConfig131C_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_XmlBinaryToJSON(object: PostgresqlHostConfig131C_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig131C_XmlOption {
...
export function postgresqlHostConfig131C_XmlOptionFromJSON(object: any): PostgresqlHostConfig131C_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig131C_XmlOptionToJSON(object: PostgresqlHostConfig131C_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig131C_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig131C(): PostgresqlHostConfig131C {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13_1C",
...
export const PostgresqlHostConfig131C = {
  $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13_1C" as const,

  encode(message: PostgresqlHostConfig131C, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig131C {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig131C();
  ...
  fromJSON(object: any): PostgresqlHostConfig131C {
    return {
      $type: PostgresqlHostConfig131C.$type,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig131C_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig131C_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig131C_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig131C_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig131C): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig131C_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig131C_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig131C>): PostgresqlHostConfig131C {
    return PostgresqlHostConfig131C.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PostgresqlHostConfig131C>): PostgresqlHostConfig131C {
    const message = createBasePostgresqlHostConfig131C();
...
messageTypeRegistry.set(PostgresqlHostConfig131C.$type, PostgresqlHostConfig131C);

...
function createBaseGetBackupRequest(): GetBackupRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.GetBackupRequest", backupId: "" };
}
...
function createBaseListBackupsRequest(): ListBackupsRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.ListBackupsRequest", folderId: "", pageSize: 0, pageToken: "" };
}
...
function createBaseListBackupsResponse(): ListBackupsResponse {
  return { $type: "yandex.cloud.mdb.postgresql.v1.ListBackupsResponse", backups: [], nextPageToken: "" };
}
...
function createBaseDeleteBackupRequest(): DeleteBackupRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.DeleteBackupRequest", backupId: "" };
}
...
function createBaseDeleteBackupMetadata(): DeleteBackupMetadata {
  return { $type: "yandex.cloud.mdb.postgresql.v1.DeleteBackupMetadata", backupId: "", clusterId: "" };
}

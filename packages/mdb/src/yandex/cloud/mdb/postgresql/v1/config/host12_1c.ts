...
export function postgresqlHostConfig121C_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig121C_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig121C_BackslashQuoteToJSON(object: PostgresqlHostConfig121C_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig121C_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_ByteaOutputFromJSON(object: any): PostgresqlHostConfig121C_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig121C_ByteaOutputToJSON(object: PostgresqlHostConfig121C_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig121C_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_ConstraintExclusionToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig121C_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_ForceParallelModeToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig121C_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_LogErrorVerbosityToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig121C_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_LogLevelFromJSON(object: any): PostgresqlHostConfig121C_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig121C_LogLevelToJSON(object: PostgresqlHostConfig121C_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig121C_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_LogStatementFromJSON(object: any): PostgresqlHostConfig121C_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig121C_LogStatementToJSON(object: PostgresqlHostConfig121C_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig121C_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_TransactionIsolationToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig121C_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_XmlBinaryFromJSON(object: any): PostgresqlHostConfig121C_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig121C_XmlBinaryToJSON(object: PostgresqlHostConfig121C_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig121C_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig121C_XmlOptionFromJSON(object: any): PostgresqlHostConfig121C_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig121C_XmlOptionToJSON(object: PostgresqlHostConfig121C_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig121C_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig121C(): PostgresqlHostConfig121C {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig12_1C",
...
export const PostgresqlHostConfig121C = {
  ...
  encode(message: PostgresqlHostConfig121C, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig121C {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig121C();
  ...
  fromJSON(object: any): PostgresqlHostConfig121C {
    return {
      $type: PostgresqlHostConfig121C.$type,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig121C_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig121C_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig121C_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig121C_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig121C): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig121C_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig121C_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig121C>): PostgresqlHostConfig121C {
    return PostgresqlHostConfig121C.fromPartial(base ?? {});
  },
...
messageTypeRegistry.set(PostgresqlHostConfig121C.$type, PostgresqlHostConfig121C);

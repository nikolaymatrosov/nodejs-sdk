...
export enum PostgresqlHostConfig16_BackslashQuote {
...
export function postgresqlHostConfig16_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig16_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_BackslashQuoteToJSON(object: PostgresqlHostConfig16_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_ByteaOutput {
...
export function postgresqlHostConfig16_ByteaOutputFromJSON(object: any): PostgresqlHostConfig16_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_ByteaOutputToJSON(object: PostgresqlHostConfig16_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_ConstraintExclusion {
...
export function postgresqlHostConfig16_ConstraintExclusionFromJSON(
  object: any,
): PostgresqlHostConfig16_ConstraintExclusion {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_ConstraintExclusionToJSON(
  object: PostgresqlHostConfig16_ConstraintExclusion,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_DebugParallelQuery {
...
export function postgresqlHostConfig16_DebugParallelQueryFromJSON(
  object: any,
): PostgresqlHostConfig16_DebugParallelQuery {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_DebugParallelQueryToJSON(
  object: PostgresqlHostConfig16_DebugParallelQuery,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_DebugParallelQuery.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_ForceParallelMode {
...
export function postgresqlHostConfig16_ForceParallelModeFromJSON(
  object: any,
...
export function postgresqlHostConfig16_ForceParallelModeToJSON(
  object: PostgresqlHostConfig16_ForceParallelMode,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_LogErrorVerbosity {
...
export function postgresqlHostConfig16_LogErrorVerbosityFromJSON(
  object: any,
): PostgresqlHostConfig16_LogErrorVerbosity {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_LogErrorVerbosityToJSON(
  object: PostgresqlHostConfig16_LogErrorVerbosity,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_LogLevel {
...
export function postgresqlHostConfig16_LogLevelFromJSON(object: any): PostgresqlHostConfig16_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_LogLevelToJSON(object: PostgresqlHostConfig16_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_LogStatement {
...
export function postgresqlHostConfig16_LogStatementFromJSON(object: any): PostgresqlHostConfig16_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_LogStatementToJSON(object: PostgresqlHostConfig16_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_TransactionIsolation {
...
export function postgresqlHostConfig16_TransactionIsolationFromJSON(
  object: any,
...
export function postgresqlHostConfig16_TransactionIsolationToJSON(
  object: PostgresqlHostConfig16_TransactionIsolation,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_XmlBinary {
...
export function postgresqlHostConfig16_XmlBinaryFromJSON(object: any): PostgresqlHostConfig16_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_XmlBinaryToJSON(object: PostgresqlHostConfig16_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig16_XmlOption {
...
export function postgresqlHostConfig16_XmlOptionFromJSON(object: any): PostgresqlHostConfig16_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig16_XmlOptionToJSON(object: PostgresqlHostConfig16_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig16_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig16(): PostgresqlHostConfig16 {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig16",
...
export const PostgresqlHostConfig16 = {
  $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig16" as const,

  encode(message: PostgresqlHostConfig16, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig16 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig16();
  ...
  fromJSON(object: any): PostgresqlHostConfig16 {
    return {
      $type: PostgresqlHostConfig16.$type,
      ...
      clientMinMessages: isSet(object.clientMinMessages)
        ...
        : 0,
      logMinMessages: isSet(object.logMinMessages) ? postgresqlHostConfig16_LogLevelFromJSON(object.logMinMessages) : 0,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig16_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig16_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig16_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig16_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig16): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig16_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig16_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig16>): PostgresqlHostConfig16 {
    return PostgresqlHostConfig16.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PostgresqlHostConfig16>): PostgresqlHostConfig16 {
    const message = createBasePostgresqlHostConfig16();
...
messageTypeRegistry.set(PostgresqlHostConfig16.$type, PostgresqlHostConfig16);

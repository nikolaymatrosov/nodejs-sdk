...
export function postgresqlHostConfig96_ConstraintExclusionToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig96_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_ForceParallelModeToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig96_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_LogLevelFromJSON(object: any): PostgresqlHostConfig96_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig96_LogLevelToJSON(object: PostgresqlHostConfig96_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig96_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_LogErrorVerbosityToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig96_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_LogStatementFromJSON(object: any): PostgresqlHostConfig96_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig96_LogStatementToJSON(object: PostgresqlHostConfig96_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig96_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_TransactionIsolationToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig96_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_ByteaOutputFromJSON(object: any): PostgresqlHostConfig96_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig96_ByteaOutputToJSON(object: PostgresqlHostConfig96_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig96_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_XmlBinaryFromJSON(object: any): PostgresqlHostConfig96_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig96_XmlBinaryToJSON(object: PostgresqlHostConfig96_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig96_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_XmlOptionFromJSON(object: any): PostgresqlHostConfig96_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig96_XmlOptionToJSON(object: PostgresqlHostConfig96_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig96_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig96_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig96_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig96_BackslashQuoteToJSON(object: PostgresqlHostConfig96_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig96_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig96(): PostgresqlHostConfig96 {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig9_6",
...
export const PostgresqlHostConfig96 = {
  ...
  encode(message: PostgresqlHostConfig96, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig96 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig96();
  ...
  fromJSON(object: any): PostgresqlHostConfig96 {
    return {
      $type: PostgresqlHostConfig96.$type,
      ...
      clientMinMessages: isSet(object.clientMinMessages)
        ...
        : 0,
      logMinMessages: isSet(object.logMinMessages) ? postgresqlHostConfig96_LogLevelFromJSON(object.logMinMessages) : 0,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig96_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig96_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig96_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig96_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig96): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig96_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig96_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig96>): PostgresqlHostConfig96 {
    return PostgresqlHostConfig96.fromPartial(base ?? {});
  },

...
import { Database, DatabaseSpec, Extension } from "./database";
...
function createBaseGetDatabaseRequest(): GetDatabaseRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.GetDatabaseRequest", clusterId: "", databaseName: "" };
}
...
function createBaseListDatabasesRequest(): ListDatabasesRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.ListDatabasesRequest", clusterId: "", pageSize: 0, pageToken: "" };
}
...
function createBaseListDatabasesResponse(): ListDatabasesResponse {
  return { $type: "yandex.cloud.mdb.postgresql.v1.ListDatabasesResponse", databases: [], nextPageToken: "" };
}
...
function createBaseCreateDatabaseRequest(): CreateDatabaseRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.CreateDatabaseRequest", clusterId: "", databaseSpec: undefined };
}
...
function createBaseCreateDatabaseMetadata(): CreateDatabaseMetadata {
  return { $type: "yandex.cloud.mdb.postgresql.v1.CreateDatabaseMetadata", clusterId: "", databaseName: "" };
}
...
export const UpdateDatabaseRequest = {
  ...
  fromJSON(object: any): UpdateDatabaseRequest {
    return {
      ...
      clusterId: isSet(object.clusterId) ? globalThis.String(object.clusterId) : "",
      databaseName: isSet(object.databaseName) ? globalThis.String(object.databaseName) : "",
      newDatabaseName: isSet(object.newDatabaseName) ? globalThis.String(object.newDatabaseName) : "",
...
function createBaseUpdateDatabaseMetadata(): UpdateDatabaseMetadata {
  return { $type: "yandex.cloud.mdb.postgresql.v1.UpdateDatabaseMetadata", clusterId: "", databaseName: "" };
}
...
function createBaseDeleteDatabaseRequest(): DeleteDatabaseRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.DeleteDatabaseRequest", clusterId: "", databaseName: "" };
}
...
function createBaseDeleteDatabaseMetadata(): DeleteDatabaseMetadata {
  return { $type: "yandex.cloud.mdb.postgresql.v1.DeleteDatabaseMetadata", clusterId: "", databaseName: "" };
}

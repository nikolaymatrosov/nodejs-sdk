...
export function postgresqlHostConfig13_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig13_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig13_BackslashQuoteToJSON(object: PostgresqlHostConfig13_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig13_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_ByteaOutputFromJSON(object: any): PostgresqlHostConfig13_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig13_ByteaOutputToJSON(object: PostgresqlHostConfig13_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig13_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_ConstraintExclusionToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig13_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_ForceParallelModeToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig13_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_LogErrorVerbosityToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig13_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_LogLevelFromJSON(object: any): PostgresqlHostConfig13_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig13_LogLevelToJSON(object: PostgresqlHostConfig13_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig13_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_LogStatementFromJSON(object: any): PostgresqlHostConfig13_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig13_LogStatementToJSON(object: PostgresqlHostConfig13_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig13_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_TransactionIsolationToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig13_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_XmlBinaryFromJSON(object: any): PostgresqlHostConfig13_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig13_XmlBinaryToJSON(object: PostgresqlHostConfig13_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig13_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function postgresqlHostConfig13_XmlOptionFromJSON(object: any): PostgresqlHostConfig13_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig13_XmlOptionToJSON(object: PostgresqlHostConfig13_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig13_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig13(): PostgresqlHostConfig13 {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig13",
...
export const PostgresqlHostConfig13 = {
  ...
  encode(message: PostgresqlHostConfig13, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig13 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig13();
  ...
  fromJSON(object: any): PostgresqlHostConfig13 {
    return {
      $type: PostgresqlHostConfig13.$type,
      ...
      clientMinMessages: isSet(object.clientMinMessages)
        ...
        : 0,
      logMinMessages: isSet(object.logMinMessages) ? postgresqlHostConfig13_LogLevelFromJSON(object.logMinMessages) : 0,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig13_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig13_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig13_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig13_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig13): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig13_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig13_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig13>): PostgresqlHostConfig13 {
    return PostgresqlHostConfig13.fromPartial(base ?? {});
  },

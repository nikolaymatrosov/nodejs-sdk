...
function createBaseGetResourcePresetRequest(): GetResourcePresetRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.GetResourcePresetRequest", resourcePresetId: "" };
}
...
function createBaseListResourcePresetsRequest(): ListResourcePresetsRequest {
  return { $type: "yandex.cloud.mdb.postgresql.v1.ListResourcePresetsRequest", pageSize: 0, pageToken: "" };
}

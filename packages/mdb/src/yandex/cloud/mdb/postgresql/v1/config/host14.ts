...
export enum PostgresqlHostConfig14_BackslashQuote {
...
export function postgresqlHostConfig14_BackslashQuoteFromJSON(object: any): PostgresqlHostConfig14_BackslashQuote {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig14_BackslashQuoteToJSON(object: PostgresqlHostConfig14_BackslashQuote): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_BackslashQuote.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_ByteaOutput {
...
export function postgresqlHostConfig14_ByteaOutputFromJSON(object: any): PostgresqlHostConfig14_ByteaOutput {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig14_ByteaOutputToJSON(object: PostgresqlHostConfig14_ByteaOutput): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_ByteaOutput.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_ConstraintExclusion {
...
export function postgresqlHostConfig14_ConstraintExclusionFromJSON(
  object: any,
): PostgresqlHostConfig14_ConstraintExclusion {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig14_ConstraintExclusionToJSON(
  object: PostgresqlHostConfig14_ConstraintExclusion,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_ConstraintExclusion.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_ForceParallelMode {
...
export function postgresqlHostConfig14_ForceParallelModeFromJSON(
  object: any,
...
export function postgresqlHostConfig14_ForceParallelModeToJSON(
  object: PostgresqlHostConfig14_ForceParallelMode,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_ForceParallelMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_LogErrorVerbosity {
...
export function postgresqlHostConfig14_LogErrorVerbosityFromJSON(
  object: any,
...
export function postgresqlHostConfig14_LogErrorVerbosityToJSON(
  ...
  switch (object) {
    ...
    case PostgresqlHostConfig14_LogErrorVerbosity.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_LogLevel {
...
export function postgresqlHostConfig14_LogLevelFromJSON(object: any): PostgresqlHostConfig14_LogLevel {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig14_LogLevelToJSON(object: PostgresqlHostConfig14_LogLevel): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_LogLevel.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_LogStatement {
...
export function postgresqlHostConfig14_LogStatementFromJSON(object: any): PostgresqlHostConfig14_LogStatement {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig14_LogStatementToJSON(object: PostgresqlHostConfig14_LogStatement): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_LogStatement.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_TransactionIsolation {
...
export function postgresqlHostConfig14_TransactionIsolationFromJSON(
  object: any,
...
export function postgresqlHostConfig14_TransactionIsolationToJSON(
  object: PostgresqlHostConfig14_TransactionIsolation,
): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_TransactionIsolation.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_XmlBinary {
...
export function postgresqlHostConfig14_XmlBinaryFromJSON(object: any): PostgresqlHostConfig14_XmlBinary {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig14_XmlBinaryToJSON(object: PostgresqlHostConfig14_XmlBinary): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_XmlBinary.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export enum PostgresqlHostConfig14_XmlOption {
...
export function postgresqlHostConfig14_XmlOptionFromJSON(object: any): PostgresqlHostConfig14_XmlOption {
  switch (object) {
    case 0:
...
export function postgresqlHostConfig14_XmlOptionToJSON(object: PostgresqlHostConfig14_XmlOption): string {
  switch (object) {
    ...
    case PostgresqlHostConfig14_XmlOption.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

function createBasePostgresqlHostConfig14(): PostgresqlHostConfig14 {
  return {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig14",
...
export const PostgresqlHostConfig14 = {
  $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig14" as const,

  encode(message: PostgresqlHostConfig14, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PostgresqlHostConfig14 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePostgresqlHostConfig14();
  ...
  fromJSON(object: any): PostgresqlHostConfig14 {
    return {
      $type: PostgresqlHostConfig14.$type,
      ...
      clientMinMessages: isSet(object.clientMinMessages)
        ...
        : 0,
      logMinMessages: isSet(object.logMinMessages) ? postgresqlHostConfig14_LogLevelFromJSON(object.logMinMessages) : 0,
      ...
      logStatement: isSet(object.logStatement) ? postgresqlHostConfig14_LogStatementFromJSON(object.logStatement) : 0,
      ...
      idleInTransactionSessionTimeout: isSet(object.idleInTransactionSessionTimeout)
        ...
        : undefined,
      byteaOutput: isSet(object.byteaOutput) ? postgresqlHostConfig14_ByteaOutputFromJSON(object.byteaOutput) : 0,
      xmlbinary: isSet(object.xmlbinary) ? postgresqlHostConfig14_XmlBinaryFromJSON(object.xmlbinary) : 0,
      xmloption: isSet(object.xmloption) ? postgresqlHostConfig14_XmlOptionFromJSON(object.xmloption) : 0,
  ...
  toJSON(message: PostgresqlHostConfig14): unknown {
    ...
    if (message.constraintExclusion !== 0) {
      obj.constraintExclusion = postgresqlHostConfig14_ConstraintExclusionToJSON(message.constraintExclusion);
    }
    if (message.cursorTupleFraction !== undefined) {
    ...
    if (message.defaultTransactionIsolation !== 0) {
      obj.defaultTransactionIsolation = postgresqlHostConfig14_TransactionIsolationToJSON(
  ...
  create(base?: DeepPartial<PostgresqlHostConfig14>): PostgresqlHostConfig14 {
    return PostgresqlHostConfig14.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PostgresqlHostConfig14>): PostgresqlHostConfig14 {
    const message = createBasePostgresqlHostConfig14();
...
messageTypeRegistry.set(PostgresqlHostConfig14.$type, PostgresqlHostConfig14);

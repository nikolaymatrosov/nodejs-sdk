...
export function topicConfig21_CleanupPolicyFromJSON(object: any): TopicConfig21_CleanupPolicy {
  switch (object) {
    case 0:
...
export function topicConfig21_CleanupPolicyToJSON(object: TopicConfig21_CleanupPolicy): string {
  switch (object) {
    ...
    case TopicConfig21_CleanupPolicy.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function topicConfig26_CleanupPolicyFromJSON(object: any): TopicConfig26_CleanupPolicy {
  switch (object) {
    case 0:
    case "CLEANUP_POLICY_UNSPECIFIED":
...
export function topicConfig26_CleanupPolicyToJSON(object: TopicConfig26_CleanupPolicy): string {
  switch (object) {
    ...
    case TopicConfig26_CleanupPolicy.CLEANUP_POLICY_COMPACT_AND_DELETE:
      return "CLEANUP_POLICY_COMPACT_AND_DELETE";
    case TopicConfig26_CleanupPolicy.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
function createBaseTopic(): Topic {
  return {
    ...
    topicConfig21: undefined,
    topicConfig26: undefined,
...
export const Topic = {
  ...
  fromJSON(object: any): Topic {
    return {
      ...
      topicConfig21: isSet(object.topicConfig_2_1) ? TopicConfig21.fromJSON(object.topicConfig_2_1) : undefined,
      topicConfig26: isSet(object.topicConfig_2_6) ? TopicConfig26.fromJSON(object.topicConfig_2_6) : undefined,
  ...
  toJSON(message: Topic): unknown {
    ...
    if (message.topicConfig21 !== undefined) {
      obj.topicConfig_2_1 = TopicConfig21.toJSON(message.topicConfig21);
    }
    if (message.topicConfig26 !== undefined) {
      obj.topicConfig_2_6 = TopicConfig26.toJSON(message.topicConfig26);
    }
    if (message.topicConfig28 !== undefined) {
  ...
  fromPartial(object: DeepPartial<Topic>): Topic {
    ...
    message.topicConfig21 = (object.topicConfig21 !== undefined && object.topicConfig21 !== null)
      ? TopicConfig21.fromPartial(object.topicConfig21)
      : undefined;
    message.topicConfig26 = (object.topicConfig26 !== undefined && object.topicConfig26 !== null)
...
function createBaseTopicConfig21(): TopicConfig21 {
  return {
    $type: "yandex.cloud.mdb.kafka.v1.TopicConfig2_1",
    cleanupPolicy: 0,
    compressionType: 0,
...
export const TopicConfig21 = {
  ...
  encode(message: TopicConfig21, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TopicConfig21 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTopicConfig21();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): TopicConfig21 {
    return {
      $type: TopicConfig21.$type,
      cleanupPolicy: isSet(object.cleanupPolicy) ? topicConfig21_CleanupPolicyFromJSON(object.cleanupPolicy) : 0,
  ...
  create(base?: DeepPartial<TopicConfig21>): TopicConfig21 {
    return TopicConfig21.fromPartial(base ?? {});
  },
...
function createBaseTopicConfig26(): TopicConfig26 {
  return {
    $type: "yandex.cloud.mdb.kafka.v1.TopicConfig2_6",
    cleanupPolicy: 0,
    compressionType: 0,
...
export const TopicConfig26 = {
  ...
  encode(message: TopicConfig26, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.cleanupPolicy !== 0) {
      writer.uint32(8).int32(message.cleanupPolicy);
    }
    if (message.compressionType !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TopicConfig26 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTopicConfig26();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): TopicConfig26 {
    return {
      $type: TopicConfig26.$type,
      cleanupPolicy: isSet(object.cleanupPolicy) ? topicConfig26_CleanupPolicyFromJSON(object.cleanupPolicy) : 0,
      compressionType: isSet(object.compressionType) ? compressionTypeFromJSON(object.compressionType) : 0,
      deleteRetentionMs: isSet(object.deleteRetentionMs) ? Number(object.deleteRetentionMs) : undefined,
      fileDeleteDelayMs: isSet(object.fileDeleteDelayMs) ? Number(object.fileDeleteDelayMs) : undefined,
      flushMessages: isSet(object.flushMessages) ? Number(object.flushMessages) : undefined,
  ...
  create(base?: DeepPartial<TopicConfig26>): TopicConfig26 {
    return TopicConfig26.fromPartial(base ?? {});
  },

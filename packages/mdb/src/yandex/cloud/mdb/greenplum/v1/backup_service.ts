...
function createBaseGetBackupRequest(): GetBackupRequest {
  return { $type: "yandex.cloud.mdb.greenplum.v1.GetBackupRequest", backupId: "" };
}

export const GetBackupRequest = {
  $type: "yandex.cloud.mdb.greenplum.v1.GetBackupRequest" as const,
...
function createBaseListBackupsRequest(): ListBackupsRequest {
  return { $type: "yandex.cloud.mdb.greenplum.v1.ListBackupsRequest", folderId: "", pageSize: 0, pageToken: "" };
}

export const ListBackupsRequest = {
  $type: "yandex.cloud.mdb.greenplum.v1.ListBackupsRequest" as const,
...
function createBaseListBackupsResponse(): ListBackupsResponse {
  return { $type: "yandex.cloud.mdb.greenplum.v1.ListBackupsResponse", backups: [], nextPageToken: "" };
}

export const ListBackupsResponse = {
  $type: "yandex.cloud.mdb.greenplum.v1.ListBackupsResponse" as const,
...
function createBaseDeleteBackupRequest(): DeleteBackupRequest {
  return { $type: "yandex.cloud.mdb.greenplum.v1.DeleteBackupRequest", backupId: "" };
}

export const DeleteBackupRequest = {
  $type: "yandex.cloud.mdb.greenplum.v1.DeleteBackupRequest" as const,
...
function createBaseDeleteBackupMetadata(): DeleteBackupMetadata {
  return { $type: "yandex.cloud.mdb.greenplum.v1.DeleteBackupMetadata", backupId: "", clusterId: "" };
}

export const DeleteBackupMetadata = {
  $type: "yandex.cloud.mdb.greenplum.v1.DeleteBackupMetadata" as const,
  ...
  create(base?: DeepPartial<DeleteBackupMetadata>): DeleteBackupMetadata {
    return DeleteBackupMetadata.fromPartial(base ?? {});
  },

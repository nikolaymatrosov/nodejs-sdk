...
function createBaseGetResourcePresetRequest(): GetResourcePresetRequest {
  return { $type: "yandex.cloud.mdb.greenplum.v1.GetResourcePresetRequest", resourcePresetId: "", type: 0 };
}
...
function createBaseListResourcePresetsRequest(): ListResourcePresetsRequest {
  return { $type: "yandex.cloud.mdb.greenplum.v1.ListResourcePresetsRequest", pageSize: 0, pageToken: "", type: 0 };
}
...
function createBaseListResourcePresetsResponse(): ListResourcePresetsResponse {
  return { $type: "yandex.cloud.mdb.greenplum.v1.ListResourcePresetsResponse", resourcePresets: [], nextPageToken: "" };
}

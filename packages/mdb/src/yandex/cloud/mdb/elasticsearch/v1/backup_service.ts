...
function createBaseGetBackupRequest(): GetBackupRequest {
  return { $type: "yandex.cloud.mdb.elasticsearch.v1.GetBackupRequest", backupId: "" };
}

export const GetBackupRequest = {
  $type: "yandex.cloud.mdb.elasticsearch.v1.GetBackupRequest" as const,
...
function createBaseListBackupsRequest(): ListBackupsRequest {
  return { $type: "yandex.cloud.mdb.elasticsearch.v1.ListBackupsRequest", folderId: "", pageSize: 0, pageToken: "" };
}

export const ListBackupsRequest = {
  $type: "yandex.cloud.mdb.elasticsearch.v1.ListBackupsRequest" as const,
...
function createBaseListBackupsResponse(): ListBackupsResponse {
  return { $type: "yandex.cloud.mdb.elasticsearch.v1.ListBackupsResponse", backups: [], nextPageToken: "" };
}

export const ListBackupsResponse = {
  $type: "yandex.cloud.mdb.elasticsearch.v1.ListBackupsResponse" as const,

...
export const MaintenanceWindow = {
  $type: "yandex.cloud.mdb.elasticsearch.v1.MaintenanceWindow" as const,
...
function createBaseAnytimeMaintenanceWindow(): AnytimeMaintenanceWindow {
  return { $type: "yandex.cloud.mdb.elasticsearch.v1.AnytimeMaintenanceWindow" };
}

export const AnytimeMaintenanceWindow = {
  $type: "yandex.cloud.mdb.elasticsearch.v1.AnytimeMaintenanceWindow" as const,
...
function createBaseWeeklyMaintenanceWindow(): WeeklyMaintenanceWindow {
  return { $type: "yandex.cloud.mdb.elasticsearch.v1.WeeklyMaintenanceWindow", day: 0, hour: 0 };
}

export const WeeklyMaintenanceWindow = {
  $type: "yandex.cloud.mdb.elasticsearch.v1.WeeklyMaintenanceWindow" as const,
...
function createBaseMaintenanceOperation(): MaintenanceOperation {
  return { $type: "yandex.cloud.mdb.elasticsearch.v1.MaintenanceOperation", info: "", delayedUntil: undefined };
}

export const MaintenanceOperation = {
  $type: "yandex.cloud.mdb.elasticsearch.v1.MaintenanceOperation" as const,

...
function createBaseGetResourcePresetRequest(): GetResourcePresetRequest {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.GetResourcePresetRequest", resourcePresetId: "" };
}
...
function createBaseListResourcePresetsRequest(): ListResourcePresetsRequest {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.ListResourcePresetsRequest", pageSize: 0, pageToken: "" };
}

...
function createBaseGetDatabaseRequest(): GetDatabaseRequest {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.GetDatabaseRequest", clusterId: "", databaseName: "" };
}
...
function createBaseListDatabasesRequest(): ListDatabasesRequest {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.ListDatabasesRequest", clusterId: "", pageSize: 0, pageToken: "" };
}
...
function createBaseListDatabasesResponse(): ListDatabasesResponse {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.ListDatabasesResponse", databases: [], nextPageToken: "" };
}
...
function createBaseCreateDatabaseRequest(): CreateDatabaseRequest {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.CreateDatabaseRequest", clusterId: "", databaseSpec: undefined };
}
...
function createBaseCreateDatabaseMetadata(): CreateDatabaseMetadata {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.CreateDatabaseMetadata", clusterId: "", databaseName: "" };
}
...
function createBaseDeleteDatabaseRequest(): DeleteDatabaseRequest {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.DeleteDatabaseRequest", clusterId: "", databaseName: "" };
}
...
function createBaseDeleteDatabaseMetadata(): DeleteDatabaseMetadata {
  return { $type: "yandex.cloud.mdb.clickhouse.v1.DeleteDatabaseMetadata", clusterId: "", databaseName: "" };
}

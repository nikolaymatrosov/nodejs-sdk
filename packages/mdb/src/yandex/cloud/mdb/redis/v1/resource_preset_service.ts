...
function createBaseGetResourcePresetRequest(): GetResourcePresetRequest {
  return { $type: "yandex.cloud.mdb.redis.v1.GetResourcePresetRequest", resourcePresetId: "" };
}
...
function createBaseListResourcePresetsRequest(): ListResourcePresetsRequest {
  return { $type: "yandex.cloud.mdb.redis.v1.ListResourcePresetsRequest", pageSize: 0, pageToken: "" };
}
...
function createBaseListResourcePresetsResponse(): ListResourcePresetsResponse {
  return { $type: "yandex.cloud.mdb.redis.v1.ListResourcePresetsResponse", resourcePresets: [], nextPageToken: "" };
}

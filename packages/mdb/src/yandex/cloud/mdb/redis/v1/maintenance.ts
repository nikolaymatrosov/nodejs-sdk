...
function createBaseAnytimeMaintenanceWindow(): AnytimeMaintenanceWindow {
  return { $type: "yandex.cloud.mdb.redis.v1.AnytimeMaintenanceWindow" };
}
...
function createBaseWeeklyMaintenanceWindow(): WeeklyMaintenanceWindow {
  return { $type: "yandex.cloud.mdb.redis.v1.WeeklyMaintenanceWindow", day: 0, hour: 0 };
}
...
function createBaseMaintenanceOperation(): MaintenanceOperation {
  return { $type: "yandex.cloud.mdb.redis.v1.MaintenanceOperation", info: "", delayedUntil: undefined };
}

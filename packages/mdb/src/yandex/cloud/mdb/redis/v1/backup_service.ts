...
function createBaseGetBackupRequest(): GetBackupRequest {
  return { $type: "yandex.cloud.mdb.redis.v1.GetBackupRequest", backupId: "" };
}
...
function createBaseListBackupsRequest(): ListBackupsRequest {
  return { $type: "yandex.cloud.mdb.redis.v1.ListBackupsRequest", folderId: "", pageSize: 0, pageToken: "" };
}
...
function createBaseListBackupsResponse(): ListBackupsResponse {
  return { $type: "yandex.cloud.mdb.redis.v1.ListBackupsResponse", backups: [], nextPageToken: "" };
}

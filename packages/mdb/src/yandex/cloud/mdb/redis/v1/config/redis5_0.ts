...
export interface RedisConfig50 {
  ...
  clientOutputBufferLimitNormal?: RedisConfig50_ClientOutputBufferLimit | undefined;
}
...
export function redisConfig50_MaxmemoryPolicyFromJSON(object: any): RedisConfig50_MaxmemoryPolicy {
  switch (object) {
    case 0:
...
export function redisConfig50_MaxmemoryPolicyToJSON(object: RedisConfig50_MaxmemoryPolicy): string {
  switch (object) {
    ...
    case RedisConfig50_MaxmemoryPolicy.NOEVICTION:
      return "NOEVICTION";
    case RedisConfig50_MaxmemoryPolicy.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
function createBaseRedisConfig50(): RedisConfig50 {
  return {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig5_0",
    maxmemoryPolicy: 0,
    timeout: undefined,
...
export const RedisConfig50 = {
  ...
  encode(message: RedisConfig50, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.clientOutputBufferLimitPubsub !== undefined) {
      RedisConfig50_ClientOutputBufferLimit.encode(message.clientOutputBufferLimitPubsub, writer.uint32(66).fork())
        .ldelim();
    }
    if (message.clientOutputBufferLimitNormal !== undefined) {
      RedisConfig50_ClientOutputBufferLimit.encode(message.clientOutputBufferLimitNormal, writer.uint32(74).fork())
        .ldelim();
    }
    return writer;
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RedisConfig50 {
    ...
    const message = createBaseRedisConfig50();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.clientOutputBufferLimitPubsub = RedisConfig50_ClientOutputBufferLimit.decode(reader, reader.uint32());
          continue;
        case 9:
          if (tag !== 74) {
            break;
          ...
          message.clientOutputBufferLimitNormal = RedisConfig50_ClientOutputBufferLimit.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): RedisConfig50 {
    return {
      ...
      clientOutputBufferLimitPubsub: isSet(object.clientOutputBufferLimitPubsub)
        ? RedisConfig50_ClientOutputBufferLimit.fromJSON(object.clientOutputBufferLimitPubsub)
        : undefined,
      clientOutputBufferLimitNormal: isSet(object.clientOutputBufferLimitNormal)
        ? RedisConfig50_ClientOutputBufferLimit.fromJSON(object.clientOutputBufferLimitNormal)
        : undefined,
    };
  },
  ...
  toJSON(message: RedisConfig50): unknown {
    ...
    if (message.clientOutputBufferLimitPubsub !== undefined) {
      obj.clientOutputBufferLimitPubsub = RedisConfig50_ClientOutputBufferLimit.toJSON(
        message.clientOutputBufferLimitPubsub,
      );
    }
    if (message.clientOutputBufferLimitNormal !== undefined) {
      obj.clientOutputBufferLimitNormal = RedisConfig50_ClientOutputBufferLimit.toJSON(
  ...
  create(base?: DeepPartial<RedisConfig50>): RedisConfig50 {
    return RedisConfig50.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RedisConfig50>): RedisConfig50 {
    ...
    message.clientOutputBufferLimitPubsub =
      (object.clientOutputBufferLimitPubsub !== undefined && object.clientOutputBufferLimitPubsub !== null)
        ? RedisConfig50_ClientOutputBufferLimit.fromPartial(object.clientOutputBufferLimitPubsub)
        : undefined;
    message.clientOutputBufferLimitNormal =
      (object.clientOutputBufferLimitNormal !== undefined && object.clientOutputBufferLimitNormal !== null)
        ? RedisConfig50_ClientOutputBufferLimit.fromPartial(object.clientOutputBufferLimitNormal)
        : undefined;
    return message;
  },
};
...
function createBaseRedisConfig50_ClientOutputBufferLimit(): RedisConfig50_ClientOutputBufferLimit {
  return {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.ClientOutputBufferLimit",
    hardLimit: undefined,
    softLimit: undefined,
...
export const RedisConfig50_ClientOutputBufferLimit = {
  $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig5_0.ClientOutputBufferLimit" as const,

  encode(message: RedisConfig50_ClientOutputBufferLimit, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RedisConfig50_ClientOutputBufferLimit {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRedisConfig50_ClientOutputBufferLimit();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RedisConfig50_ClientOutputBufferLimit {
    return {
      $type: RedisConfig50_ClientOutputBufferLimit.$type,
  ...
  create(base?: DeepPartial<RedisConfig50_ClientOutputBufferLimit>): RedisConfig50_ClientOutputBufferLimit {
    return RedisConfig50_ClientOutputBufferLimit.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RedisConfig50_ClientOutputBufferLimit>): RedisConfig50_ClientOutputBufferLimit {
    const message = createBaseRedisConfig50_ClientOutputBufferLimit();
...
messageTypeRegistry.set(RedisConfig50_ClientOutputBufferLimit.$type, RedisConfig50_ClientOutputBufferLimit);

function createBaseRedisConfigSet50(): RedisConfigSet50 {
  return {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfigSet5_0",
...
export const RedisConfigSet50 = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RedisConfigSet50 {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRedisConfigSet50();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RedisConfigSet50 {
    return {
      $type: RedisConfigSet50.$type,
      effectiveConfig: isSet(object.effectiveConfig) ? RedisConfig50.fromJSON(object.effectiveConfig) : undefined,
      userConfig: isSet(object.userConfig) ? RedisConfig50.fromJSON(object.userConfig) : undefined,
      defaultConfig: isSet(object.defaultConfig) ? RedisConfig50.fromJSON(object.defaultConfig) : undefined,
    };
  },
  ...
  toJSON(message: RedisConfigSet50): unknown {
    const obj: any = {};
    if (message.effectiveConfig !== undefined) {
      obj.effectiveConfig = RedisConfig50.toJSON(message.effectiveConfig);
    }
    if (message.userConfig !== undefined) {
      obj.userConfig = RedisConfig50.toJSON(message.userConfig);
    }
    if (message.defaultConfig !== undefined) {
      obj.defaultConfig = RedisConfig50.toJSON(message.defaultConfig);
    }
    return obj;
  },

  create(base?: DeepPartial<RedisConfigSet50>): RedisConfigSet50 {
    return RedisConfigSet50.fromPartial(base ?? {});
  },

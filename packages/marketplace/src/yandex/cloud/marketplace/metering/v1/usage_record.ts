...
function createBaseAcceptedUsageRecord(): AcceptedUsageRecord {
  return { $type: "yandex.cloud.marketplace.metering.v1.AcceptedUsageRecord", uuid: "" };
}
...
function createBaseRejectedUsageRecord(): RejectedUsageRecord {
  return { $type: "yandex.cloud.marketplace.metering.v1.RejectedUsageRecord", uuid: "", reason: 0 };
}

...
export const WriteImageProductUsageRequest = {
  $type: "yandex.cloud.marketplace.metering.v1.WriteImageProductUsageRequest" as const,
...
function createBaseWriteImageProductUsageResponse(): WriteImageProductUsageResponse {
  return { $type: "yandex.cloud.marketplace.metering.v1.WriteImageProductUsageResponse", accepted: [], rejected: [] };
}

export const WriteImageProductUsageResponse = {
  $type: "yandex.cloud.marketplace.metering.v1.WriteImageProductUsageResponse" as const,

...
import { LogEntry, LogLevel_Level, logLevel_LevelFromJSON, logLevel_LevelToJSON } from "./log_entry";
...
function createBaseReadRequest(): ReadRequest {
  return { $type: "yandex.cloud.logging.v1.ReadRequest", pageToken: undefined, criteria: undefined };
}
...
export const ReadResponse = {
  ...
  fromJSON(object: any): ReadResponse {
    return {
      ...
      previousPageToken: isSet(object.previousPageToken) ? globalThis.String(object.previousPageToken) : "",
    };
  },
...
export const Criteria = {
  ...
  fromJSON(object: any): Criteria {
    return {
      ...
      maxResponseSize: isSet(object.maxResponseSize) ? globalThis.Number(object.maxResponseSize) : 0,
    };
  },
...
export type LogReadingServiceService = typeof LogReadingServiceService;
...
export const LogReadingServiceClient = makeGenericClientConstructor(
  ...
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): LogReadingServiceClient;
